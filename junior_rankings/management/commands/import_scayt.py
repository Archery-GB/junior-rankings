...
from junior_rankings.models import Athlete, AthleteSeason, Event, Season, Score
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for s in data:
            ...
            try:
                athlete_season = AthleteSeason.objects.get(athlete__agb_number=s["agb_number"], bowstyle=s["bowstyle"])
